...
<div class="bg-white dark:bg-[#161615] rounded-xl border border-[#e3e3e0] dark:border-[#3E3E3A] shadow-sm">
    <div class="bg-gradient-to-r from-purple-500 to-purple-600 dark:from-purple-600 dark:to-purple-700 px-8 py-6">
        ...
        <p class="text-purple-100 mt-1">Add a new product to your inventory</p>
    </div>
    ...
    <form action="{{ route('products.store') }}" method="POST" class="p-8">
        ...
        <div class="flex gap-4 pt-6 mt-6 border-t border-[#e3e3e0] dark:border-[#3E3E3A]">
            ...
            <a href="{{ route('products.index') }}" class="px-6 py-3 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors font-semibold">
                Cancel
            </a>
        </div>
    </form>
