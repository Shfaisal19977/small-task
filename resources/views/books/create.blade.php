...
<div class="bg-white dark:bg-[#161615] rounded-xl border border-[#e3e3e0] dark:border-[#3E3E3A] shadow-sm">
    <div class="bg-gradient-to-r from-blue-500 to-blue-600 dark:from-blue-600 dark:to-blue-700 px-8 py-6">
        <h1 class="text-3xl font-bold text-white">Create New Book</h1>
        <p class="text-blue-100 mt-1">Add a new book to your collection</p>
    </div>
    ...
    <form action="{{ route('books.store') }}" method="POST" class="p-8">
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <input type="number" name="publication_year" id="publication_year" value="{{ old('publication_year') }}" required min="1000" max="9999"
                    class="w-full px-4 py-3 border-2 border-[#e3e3e0] dark:border-[#3E3E3A] rounded-lg bg-white dark:bg-[#0a0a0a] text-[#1b1b18] dark:text-[#EDEDEC] focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all"
                    placeholder="YYYY">
            ...
            <div class="flex gap-4 pt-4">
                ...
                <a href="{{ route('books.index') }}" class="px-6 py-3 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors font-semibold">
                    Cancel
                </a>
            </div>
        </div>
