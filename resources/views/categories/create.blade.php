...
<div class="bg-white dark:bg-[#161615] rounded-xl border border-[#e3e3e0] dark:border-[#3E3E3A] shadow-sm">
    <div class="bg-gradient-to-r from-green-500 to-green-600 dark:from-green-600 dark:to-green-700 px-8 py-6">
        ...
        <p class="text-green-100 mt-1">Add a new category to organize your products</p>
    </div>
    ...
    <form action="{{ route('categories.store') }}" method="POST" class="p-8">
        ...
        <div class="space-y-6">
            ...
            <div class="flex gap-4 pt-4">
                ...
                <a href="{{ route('categories.index') }}" class="px-6 py-3 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors font-semibold">
                    Cancel
                </a>
            </div>
        </div>
